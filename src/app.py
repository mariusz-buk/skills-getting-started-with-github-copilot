...
activities = {
    ...
    "Basketball Training": {
        "description": "Improve basketball techniques and team play",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["kevin@mergington.edu", "taylor@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Workshop": {
        "description": "Develop acting skills and prepare short performances",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["mason@mergington.edu", "zoe@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking and competitive debate strategies",
